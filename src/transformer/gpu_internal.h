...
typedef struct {
    ...
    void *ffn_gate;
    void *ffn_up;
    void *ffn_gate_reference;
    void *ffn_up_reference;
    void *ffn_down;
    void *ffn_down_prefill;
    void *ffn_post_norm;
    void *ffn_post_norm_1;
    void *ffn_post_norm_2;
...
typedef struct {
    ...
    void *proj;
    void *post_norm;
} BnTransformerGPUPerLayerInputResources;
...
typedef struct {
    ...
    BnTransformerGPUPerLayerInputResources per_layer_input;
...
typedef struct {
    ...
    void *initial_norm;
    void *output_norm;
    BnTransformerGPUHyperConnectionResources hc_output;
    BnTransformerGPULogitResources logits;
    int has_tq;
    int has_moe;
    int has_ssm;
    int moe_separate_router_topk;
...
typedef struct {
    int use_layer;
    int small_dense_native_quant_path;
    int use_attention;
    int use_hc_attention;
    int use_ffn;
    int use_ffn_down;
...
int bn_transformer_gpu_moe_prefill_tokens_allowed(
    const BnGPUBackend *gpu,
    int n_tokens);
int bn_transformer_gpu_moe_cache_prefill_enabled(const BnGPUBackend *gpu);
...
int bn_transformer_gpu_moe_routed_lowbit_block32(const BnMoEExpertMap *map);
