...
int bn_gpu_policy_moe_f16_aux_cache_auto_enabled(const BnConfig *c) {
    return bn_gpu_policy_cuda_moe_f16_aux_cache_auto_enabled(c);
}
...
int bn_gpu_policy_moe_all_f16_cache_forced(void) {
    return bn_gpu_policy_cuda_moe_all_f16_cache_forced();
}
...
int bn_gpu_policy_moe_all_f16_cache_enabled_for_type(
    ...
    int tensor_type,
    int q8_f16_cache) {
    return bn_gpu_policy_cuda_moe_all_f16_cache_enabled_for_type(
        gpu, tensor_type, q8_f16_cache);
}
...
int bn_gpu_policy_moe_gateup_f16_cache_enabled(int eligible) {
    return bn_gpu_policy_cuda_moe_gateup_f16_cache_enabled(eligible);
}
...
int bn_gpu_policy_partial_moe_f16_cache_enabled(int eligible) {
    return bn_gpu_policy_cuda_partial_moe_f16_cache_enabled(eligible);
}
...
int bn_gpu_policy_moe_residency_fit_debug_enabled(void) {
    return bn_gpu_policy_cuda_moe_fit_debug_enabled();
}
...
int bn_gpu_policy_moe_down_q6_f32_cache_preferred(
    ...
    int cols,
    int force_f16_cache) {
    return bn_gpu_policy_cuda_moe_down_q6_f32_cache_preferred(
...
int bn_gpu_policy_moe_down_q6_f32_cache_requires_full_buffer(
    int tensor_type) {
    return bn_gpu_policy_cuda_moe_down_q6_f32_cache_requires_full_buffer(
        tensor_type);
}
...
int bn_gpu_policy_moe_down_q4_f32_cache_enabled(
    const BnGPUBackend *gpu,
    int tensor_type) {
    return bn_gpu_policy_cuda_moe_down_q4_f32_cache_enabled(gpu, tensor_type);
}
...
int bn_gpu_policy_moe_quant_only_after_cache(int tensor_type,
                                             int q8_f16_cache) {
    return bn_gpu_policy_cuda_moe_quant_only_after_cache(tensor_type,
                                                         q8_f16_cache);
}
...
int bn_gpu_policy_shared_q4_q8_dot_enabled(void) {
    return bn_gpu_policy_cuda_shared_q4_q8_dot_enabled();
}
...
int bn_gpu_policy_shared_expert_gate_enabled(void) {
    return bn_gpu_policy_cuda_shared_expert_gate_enabled();
}
...
int bn_gpu_policy_moe_prefill_min_tokens_configured(void) {
    return bn_gpu_policy_cuda_moe_prefill_min_tokens_configured();
}
...
int bn_gpu_policy_large_hybrid_cpu_attention_safe_enabled(void) {
    return bn_gpu_policy_cuda_large_hybrid_cpu_attention_safe_enabled();
}
...
int bn_gpu_policy_large_hybrid_cpu_attention_safe_disabled(void) {
    return bn_gpu_policy_cuda_large_hybrid_cpu_attention_safe_disabled();
}
...
int bn_gpu_policy_large_hybrid_cpu_attention_safe_forced(void) {
    return bn_gpu_policy_cuda_large_hybrid_cpu_attention_safe_forced();
}
...
int bn_gpu_policy_large_hybrid_prefill_enabled(void) {
    return bn_gpu_policy_cuda_large_hybrid_prefill_enabled();
}
...
int bn_gpu_policy_large_hybrid_prefill_chain_enabled(void) {
    return bn_gpu_policy_cuda_large_hybrid_prefill_chain_enabled();
}
...
int bn_gpu_policy_large_hybrid_argmax_enabled(void) {
    return bn_gpu_policy_cuda_large_hybrid_argmax_enabled();
}
...
int bn_gpu_policy_q8_moe_cpu_route_resident_enabled(int eligible) {
    return bn_gpu_policy_cuda_q8_moe_cpu_route_resident_enabled(eligible);
}
...
int bn_gpu_policy_moe_router_diff2_enabled(void) {
    return bn_gpu_policy_cuda_moe_router_diff2_enabled();
}
...
int bn_gpu_policy_moe_routed_ffn_batch_allowed(int large_moe) {
    return bn_gpu_policy_cuda_moe_routed_ffn_batch_allowed(large_moe);
}
...
int bn_gpu_policy_moe_cpu_actual_override_enabled(void) {
    return bn_gpu_policy_cuda_moe_cpu_actual_override_enabled();
}
...
int bn_gpu_policy_small_dense_exact_ffn_down_enabled(void) {
    return gpu_policy_compat_env_enabled("BN_CUDA_ENABLE_SMALL_DENSE_EXACT_FFN_DOWN",
...
int bn_gpu_policy_all2_q4q6_moe_fast_ffn_enabled(void) {
    return gpu_policy_compat_env_enabled("BN_CUDA_ENABLE_ALL2_Q4Q6_MOE_FAST_FFN",
                                  "BN_CUDA_ENABLE_QWEN2MOE_FAST_MOE_FFN");
}

int bn_gpu_policy_all2_q4q6_moe_fast_graph_disabled(void) {
    return gpu_policy_compat_env_enabled("BN_CUDA_DISABLE_ALL2_Q4Q6_MOE_FAST_GRAPH",
                                  "BN_CUDA_DISABLE_QWEN2MOE_FAST_MOE_GRAPH");
}

int bn_gpu_policy_all2_q4q6_moe_cublas_decode_enabled(void) {
    return gpu_policy_compat_env_enabled("BN_CUDA_ENABLE_ALL2_Q4Q6_MOE_CUBLAS_DECODE",
...
int bn_gpu_policy_all2_q4q6_moe_all2_fast_enabled(void) {
    return gpu_policy_compat_env_enabled("BN_CUDA_ENABLE_ALL2_Q4Q6_MOE_ALL2_FAST",
                                  "BN_CUDA_ENABLE_QWEN2MOE_MOE_ALL2_FAST");
}

int bn_gpu_policy_all2_q4q6_moe_q8k_default_disabled(void) {
    return gpu_policy_compat_env_enabled("BN_CUDA_DISABLE_ALL2_Q4Q6_MOE_Q8K_DEFAULT",
                                  "BN_CUDA_DISABLE_QWEN2MOE_MOE_Q8K_DEFAULT");
}

int bn_gpu_policy_all2_q4q6_route_q8k_default_disabled(void) {
    return gpu_policy_compat_env_enabled("BN_CUDA_DISABLE_ALL2_Q4Q6_ROUTE_Q8K_DEFAULT",
...
int bn_gpu_policy_all2_q4q6_fast_q8k_gateup_enabled(void) {
    return gpu_policy_compat_env_enabled("BN_CUDA_ENABLE_ALL2_Q4Q6_FAST_Q8K_GATEUP",
                                  "BN_CUDA_ENABLE_QWEN2MOE_FAST_Q8K_GATEUP");
}

int bn_gpu_policy_all2_q4q6_fast_q8k_gateup_disabled(void) {
    return gpu_policy_compat_env_enabled("BN_CUDA_DISABLE_ALL2_Q4Q6_FAST_Q8K_GATEUP",
                                  "BN_CUDA_DISABLE_QWEN2MOE_FAST_Q8K_GATEUP");
}

int bn_gpu_policy_all2_q4q6_q6k_pair_down_enabled(void) {
    return gpu_policy_compat_env_enabled("BN_CUDA_ENABLE_ALL2_Q4Q6_Q6K_PAIR_DOWN",
...
int bn_gpu_policy_all2_q4q6_q6k_ordered_down_enabled(void) {
    return gpu_policy_compat_env_enabled("BN_CUDA_ENABLE_ALL2_Q4Q6_Q6K_ORDERED_DOWN",
                                  "BN_CUDA_ENABLE_QWEN2MOE_Q6K_ORDERED_DOWN");
}

int bn_gpu_policy_all2_q4q6_q6k_ordered_down_disabled(void) {
    return gpu_policy_compat_env_enabled("BN_CUDA_DISABLE_ALL2_Q4Q6_Q6K_ORDERED_DOWN",
...
int bn_gpu_policy_all2_q4q6_q6k_f32_all2_down_disabled(void) {
    return gpu_policy_compat_env_enabled("BN_CUDA_DISABLE_ALL2_Q4Q6_Q6K_F32_ALL2_DOWN",
                                  "BN_CUDA_DISABLE_QWEN2MOE_Q6K_F32_ALL2_DOWN");
}

int bn_gpu_policy_all2_q4q6_q6k_f32_cache_enabled(void) {
    return gpu_policy_compat_env_enabled("BN_CUDA_ENABLE_ALL2_Q4Q6_Q6K_F32_CACHE",
...
int bn_gpu_policy_all2_q4q6_q6k_f32_exact_4row_down_layer_selected(
    ...
    return !env || !*env ||
           gpu_policy_compat_env_layer_selected(
               "BN_CUDA_ALL2_Q4Q6_Q6K_F32_EXACT_4ROW_DOWN_LAYERS",
...
float bn_gpu_policy_all2_q4q6_down_skip_eps_or_default(float default_eps) {
    return gpu_policy_compat_env_float_or_default("BN_CUDA_ALL2_Q4Q6_DOWN_SKIP_EPS",
...
int bn_gpu_policy_all2_q4q6_moe_exact_attention_disabled(void) {
    return gpu_policy_compat_env_enabled("BN_CUDA_DISABLE_ALL2_Q4Q6_MOE_EXACT_ATTN",
...
void bn_gpu_policy_all2_q4q6_moe_route_layer_range(int *from_layer,
    ...
    env = gpu_policy_compat_env_value("BN_CUDA_ALL2_Q4Q6_MOE_GPU_ROUTE_FROM_LAYER",
                               "BN_CUDA_QWEN2MOE_GPU_ROUTE_FROM_LAYER");
    if (env && from_layer)
        *from_layer = atoi(env);
    env = gpu_policy_compat_env_value("BN_CUDA_ALL2_Q4Q6_MOE_GPU_ROUTE_TO_LAYER",
...
int bn_gpu_policy_moe_gateup_split_enabled(int can_split) {
    return bn_gpu_policy_cuda_moe_gateup_split_enabled(can_split);
}
