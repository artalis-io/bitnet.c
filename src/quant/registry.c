...
#define BN_QUANT_CAP_GPU_DENSE_GRAPH_Q6K \
    (BN_QUANT_CAP_GPU_DENSE_GRAPH_KQUANT | BN_QUANT_CAP_Q6_LOGITS_REFINE)
...
static const BnQuantFormatOps g_quant_formats[] = {
    ...
    { BN_GGUF_TENSOR_Q4_K,     "Q4_K",     BN_QUANT_LAYOUT_BLOCK256, 256, 144, BN_QUANT_CAP_LOADABLE_CPU_EMBEDDED_PREQ8K_TIED_LOGITS | BN_QUANT_CAP_GPU_DENSE_GRAPH_KQUANT | BN_QUANT_CAP_MOE_LARGE_AUX_CACHE | BN_QUANT_CAP_MOE_DOWN_Q4_F32_CACHE | BN_QUANT_CAP_MOE_Q4_GATEUP, BN_QUANT_CPU_HOOKS },
    { BN_GGUF_TENSOR_Q5_K,     "Q5_K",     BN_QUANT_LAYOUT_BLOCK256, 256, 176, BN_QUANT_CAP_LOADABLE_CPU_EMBEDDED_PREQ8K_TIED_LOGITS | BN_QUANT_CAP_GPU_DENSE_GRAPH_KQUANT | BN_QUANT_CAP_GPU_FUSED_GATEUP_BACKEND_OPT_IN | BN_QUANT_CAP_MOE_LARGE_AUX_CACHE, BN_QUANT_CPU_HOOKS },
    { BN_GGUF_TENSOR_Q6_K,     "Q6_K",     BN_QUANT_LAYOUT_BLOCK256, 256, 210, BN_QUANT_CAP_LOADABLE_CPU_EMBEDDED_PREQ8K_TIED_LOGITS | BN_QUANT_CAP_GPU_DENSE_GRAPH_Q6K | BN_QUANT_CAP_MOE_LARGE_AUX_CACHE | BN_QUANT_CAP_LOGITS_Q6_F32_CACHE | BN_QUANT_CAP_MOE_DOWN_Q6_F32_CACHE | BN_QUANT_CAP_MOE_DOWN_CUBLAS_CACHE | BN_QUANT_CAP_AUX_CACHE_F16, BN_QUANT_CPU_HOOKS },
