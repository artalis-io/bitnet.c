...
static const BnQuantFormatOps g_quant_formats[] = {
    ...
    { BN_GGUF_TENSOR_Q4_0,     "Q4_0",     BN_QUANT_LAYOUT_BLOCK32,  32,  18,  BN_QUANT_CAP_LOADABLE_CPU_EMBEDDED_TIED_LOGITS | BN_QUANT_CAP_CPU_REPACKED | BN_QUANT_CAP_GPU_SMALL_DENSE | BN_QUANT_CAP_GPU_NATIVE | BN_QUANT_CAP_GPU_REPACKED, BN_QUANT_CPU_HOOKS },
    ...
    { BN_GGUF_TENSOR_Q8_0,     "Q8_0",     BN_QUANT_LAYOUT_BLOCK32,  32,  34,  BN_QUANT_CAP_LOADABLE_CPU_EMBEDDED_TIED_LOGITS | BN_QUANT_CAP_GPU_SMALL_DENSE_Q8_FORMAT | BN_QUANT_CAP_MOE_ALL_F16_LAZY_AUX | BN_QUANT_CAP_MOE_PREFERS_QUANT_ONLY, BN_QUANT_CPU_HOOKS },
    ...
    { BN_GGUF_TENSOR_Q4_K,     "Q4_K",     BN_QUANT_LAYOUT_BLOCK256, 256, 144, BN_QUANT_CAP_LOADABLE_CPU_EMBEDDED_PREQ8K_TIED_LOGITS | BN_QUANT_CAP_GPU_SMALL_DENSE_KQUANT | BN_QUANT_CAP_MOE_LARGE_AUX_CACHE | BN_QUANT_CAP_MOE_DOWN_Q4_F32_CACHE, BN_QUANT_CPU_HOOKS },
