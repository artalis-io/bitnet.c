...
#define BN_QUANT_CAP_LOADABLE_CPU_EMBEDDED_PREQ8K_TIED_LOGITS \
    (BN_QUANT_CAP_LOADABLE_CPU_EMBEDDED_PREQ8K | BN_QUANT_CAP_TIED_LOGITS_QUANT_PATH)
#define BN_QUANT_CAP_GPU_SMALL_DENSE_NATIVE_QUANT_FORMAT \
    (BN_QUANT_CAP_GPU_SMALL_DENSE | BN_QUANT_CAP_GPU_SMALL_DENSE_NATIVE_QUANT | \
     BN_QUANT_CAP_Q8_LOGITS_REFINE | BN_QUANT_CAP_GPU_EXACT_SILU | \
...
static const BnQuantFormatOps g_quant_formats[] = {
    ...
    { BN_GGUF_TENSOR_F16,      "F16",      BN_QUANT_LAYOUT_DENSE,    1,   2,   BN_QUANT_CAP_LOADABLE_CPU_EMBEDDED | BN_QUANT_CAP_GPU_SMALL_DENSE | BN_QUANT_CAP_LOGITS_F16_PATH, BN_QUANT_CPU_HOOKS },
    ...
    { BN_GGUF_TENSOR_Q4_0,     "Q4_0",     BN_QUANT_LAYOUT_BLOCK32,  32,  18,  BN_QUANT_CAP_LOADABLE_CPU_EMBEDDED_TIED_LOGITS | BN_QUANT_CAP_CPU_REPACKED | BN_QUANT_CAP_GPU_SMALL_DENSE | BN_QUANT_CAP_GPU_NATIVE | BN_QUANT_CAP_GPU_REPACKED | BN_QUANT_CAP_CPU_FUSED_Q4_GATEUP_SILU, BN_QUANT_CPU_HOOKS },
    { BN_GGUF_TENSOR_Q4_1,     "Q4_1",     BN_QUANT_LAYOUT_BLOCK32,  32,  20,  BN_QUANT_CAP_LOADABLE_CPU_EMBEDDED_TIED_LOGITS, BN_QUANT_CPU_HOOKS },
    { BN_GGUF_TENSOR_Q5_0,     "Q5_0",     BN_QUANT_LAYOUT_BLOCK32,  32,  22,  BN_QUANT_CAP_LOADABLE_CPU_EMBEDDED_TIED_LOGITS | BN_QUANT_CAP_GPU_SMALL_DENSE | BN_QUANT_CAP_AUX_CACHE, BN_QUANT_CPU_HOOKS },
    { BN_GGUF_TENSOR_Q5_1,     "Q5_1",     BN_QUANT_LAYOUT_BLOCK32,  32,  24,  BN_QUANT_CAP_LOADABLE_CPU_EMBEDDED_TIED_LOGITS, BN_QUANT_CPU_HOOKS },
    { BN_GGUF_TENSOR_Q8_0,     "Q8_0",     BN_QUANT_LAYOUT_BLOCK32,  32,  34,  BN_QUANT_CAP_LOADABLE_CPU_EMBEDDED_TIED_LOGITS | BN_QUANT_CAP_GPU_SMALL_DENSE_NATIVE_QUANT_FORMAT | BN_QUANT_CAP_MOE_ALL_F16_LAZY_AUX | BN_QUANT_CAP_MOE_PREFERS_QUANT_ONLY | BN_QUANT_CAP_MOE_Q8_ROUTE, BN_QUANT_CPU_HOOKS },
    ...
    { BN_GGUF_TENSOR_Q4_K,     "Q4_K",     BN_QUANT_LAYOUT_BLOCK256, 256, 144, BN_QUANT_CAP_LOADABLE_CPU_EMBEDDED_PREQ8K_TIED_LOGITS | BN_QUANT_CAP_GPU_SMALL_DENSE_KQUANT | BN_QUANT_CAP_MOE_LARGE_AUX_CACHE | BN_QUANT_CAP_MOE_DOWN_Q4_F32_CACHE | BN_QUANT_CAP_MOE_Q4_GATEUP, BN_QUANT_CPU_HOOKS },
    { BN_GGUF_TENSOR_Q5_K,     "Q5_K",     BN_QUANT_LAYOUT_BLOCK256, 256, 176, BN_QUANT_CAP_LOADABLE_CPU_EMBEDDED_PREQ8K_TIED_LOGITS | BN_QUANT_CAP_GPU_SMALL_DENSE_KQUANT | BN_QUANT_CAP_GPU_FUSED_GATEUP_BACKEND_OPT_IN | BN_QUANT_CAP_MOE_LARGE_AUX_CACHE, BN_QUANT_CPU_HOOKS },
    { BN_GGUF_TENSOR_Q6_K,     "Q6_K",     BN_QUANT_LAYOUT_BLOCK256, 256, 210, BN_QUANT_CAP_LOADABLE_CPU_EMBEDDED_PREQ8K_TIED_LOGITS | BN_QUANT_CAP_GPU_SMALL_DENSE_Q6K | BN_QUANT_CAP_MOE_LARGE_AUX_CACHE | BN_QUANT_CAP_LOGITS_Q6_F32_CACHE | BN_QUANT_CAP_MOE_DOWN_Q6_F32_CACHE | BN_QUANT_CAP_MOE_DOWN_CUBLAS_CACHE | BN_QUANT_CAP_AUX_CACHE_F16, BN_QUANT_CPU_HOOKS },
    { BN_GGUF_TENSOR_Q8_K,     "Q8_K",     BN_QUANT_LAYOUT_BLOCK256, 256, 292, BN_QUANT_CAP_LOADABLE_CPU_EMBEDDED_TIED_LOGITS | BN_QUANT_CAP_GPU_SMALL_DENSE, BN_QUANT_CPU_HOOKS },
...
int bn_quant_format_supports_gpu_small_dense_native_quant(int type) {
    return bn_quant_format_has_cap(type, BN_QUANT_CAP_GPU_SMALL_DENSE_NATIVE_QUANT);
}
