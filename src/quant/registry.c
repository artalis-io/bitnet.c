...
static const BnQuantFormatOps g_quant_formats[] = {
    ...
    { BN_GGUF_TENSOR_Q8_0,     "Q8_0",     BN_QUANT_LAYOUT_BLOCK32,  32,  34,  BN_QUANT_CAP_LOADABLE_CPU_EMBEDDED_TIED_LOGITS | BN_QUANT_CAP_GPU_SMALL_DENSE_Q8_FORMAT | BN_QUANT_CAP_MOE_ALL_F16_LAZY_AUX | BN_QUANT_CAP_MOE_PREFERS_QUANT_ONLY | BN_QUANT_CAP_MOE_Q8_ROUTE, BN_QUANT_CPU_HOOKS },
    ...
    { BN_GGUF_TENSOR_Q5_K,     "Q5_K",     BN_QUANT_LAYOUT_BLOCK256, 256, 176, BN_QUANT_CAP_LOADABLE_CPU_EMBEDDED_PREQ8K_TIED_LOGITS | BN_QUANT_CAP_GPU_SMALL_DENSE_KQUANT | BN_QUANT_CAP_GPU_FUSED_GATEUP_CUDA_OPT_IN | BN_QUANT_CAP_MOE_LARGE_AUX_CACHE, BN_QUANT_CPU_HOOKS },
...
int bn_quant_format_gpu_fused_gateup_requires_cuda_opt_in(int type) {
    return bn_quant_format_has_cap(type, BN_QUANT_CAP_GPU_FUSED_GATEUP_CUDA_OPT_IN);
}
