...
static void test_gpu_policy_helpers(void) {
    ...
    assert(!bn_gpu_policy_backend_q6_logits_refine_enabled(&gpu, 0));
    assert(bn_gpu_policy_backend_q6_logits_refine_enabled(&gpu, 1));
    gpu.kind = BN_GPU_BACKEND_METAL;
    assert(bn_gpu_policy_backend_q6_logits_refine_enabled(&gpu, 0));
    gpu.kind = BN_GPU_BACKEND_CUDA;
    ...
    assert(!bn_gpu_policy_backend_q8_logits_refine_enabled(&gpu, 0));
    assert(bn_gpu_policy_backend_q8_logits_refine_enabled(&gpu, 1));
    gpu.kind = BN_GPU_BACKEND_METAL;
    assert(bn_gpu_policy_backend_q8_logits_refine_enabled(&gpu, 0));
    gpu.kind = BN_GPU_BACKEND_CUDA;
    ...
    assert(bn_gpu_policy_moe_down_q6_f32_cache_preferred(
        &gpu, BN_GGUF_TENSOR_Q6_K, 1025, 0));
    assert(!bn_gpu_policy_moe_down_q6_f32_cache_preferred(
        &gpu, BN_GGUF_TENSOR_Q6_K, 2048, 1));
    assert(bn_gpu_policy_cuda_moe_down_q6_f32_cache_bytes(
        &gpu, BN_GGUF_TENSOR_Q6_K, 8, 2048, 2) ==
           32768 * sizeof(float));
    assert(bn_gpu_policy_moe_down_q6_f32_cache_bytes(
        &gpu, BN_GGUF_TENSOR_Q6_K, 8, 2048, 2) ==
           32768 * sizeof(float));
    ...
    assert(bn_gpu_policy_cuda_moe_down_q6_f32_cache_requires_full_buffer(
        BN_GGUF_TENSOR_Q6_K));
    assert(bn_gpu_policy_moe_down_q6_f32_cache_requires_full_buffer(
        BN_GGUF_TENSOR_Q6_K));
    assert(!bn_gpu_policy_cuda_moe_down_q6_f32_cache_requires_full_buffer(
        BN_GGUF_TENSOR_Q4_K));
    assert(!bn_gpu_policy_moe_down_q6_f32_cache_requires_full_buffer(
    ...
    assert(!bn_gpu_policy_cuda_q5_gateup_warp_disabled());
    ...
    assert(!bn_gpu_policy_cuda_q8_preq_all_enabled());
    assert(!bn_gpu_policy_cuda_q8_preq_logits_disabled());
    assert(bn_gpu_policy_cuda_q8_preq_logits_default_enabled(0));
    assert(bn_gpu_policy_cuda_q8k_input_cache_enabled());
    ...
    assert(!bn_gpu_policy_cuda_q8_preq_all_enabled());
    assert(bn_gpu_policy_cuda_q8_preq_logits_disabled());
    assert(!bn_gpu_policy_cuda_q8_preq_logits_default_enabled(1));
    assert(!bn_gpu_policy_cuda_q8k_input_cache_enabled());
    unsetenv("BN_CUDA_ENABLE_Q8_0_QUANT_MATMUL");
    unsetenv("BN_CUDA_DISABLE_Q8_0_QUANT_MATMUL");
    unsetenv("BN_CUDA_DISABLE_F16_Q8_0_MATMUL");
    ...
    assert(bn_gpu_policy_cuda_q6k_4warp_long_enabled(1536, 8960));
    assert(bn_gpu_policy_cuda_q6k_4warp_long_enabled(2560, 8192));
    assert(!bn_gpu_policy_cuda_q6k_4warp_long_enabled(2560, 6144));
    ...
    assert(!bn_gpu_policy_cuda_q6k_4warp_long_enabled(2560, 8192));
    assert(bn_gpu_policy_cuda_q6k_5warp_exact_enabled(1536, 8960));
    assert(bn_gpu_policy_cuda_q6k_5warp_exact_enabled(2560, 9728));
    setenv("BN_CUDA_DISABLE_Q6K_5WARP_1536_8960", "1", 1);
    setenv("BN_CUDA_DISABLE_Q6K_5WARP_2560_9728", "1", 1);
    assert(!bn_gpu_policy_cuda_q6k_5warp_exact_enabled(1536, 8960));
    assert(!bn_gpu_policy_cuda_q6k_5warp_exact_enabled(2560, 9728));
    assert(bn_gpu_policy_cuda_q6k_3warp_exact_enabled(1536, 8960));
    assert(bn_gpu_policy_cuda_q6k_3warp_exact_enabled(2560, 9728));
    setenv("BN_CUDA_DISABLE_Q6K_3WARP_1536_8960", "1", 1);
    setenv("BN_CUDA_DISABLE_Q6K_3WARP_2560_9728", "1", 1);
    assert(!bn_gpu_policy_cuda_q6k_3warp_exact_enabled(1536, 8960));
    assert(!bn_gpu_policy_cuda_q6k_3warp_exact_enabled(2560, 9728));
    assert(!bn_gpu_policy_cuda_q6k_2warp_long_enabled(2560, 8192));
    setenv("BN_CUDA_ENABLE_Q6K_2WARP_LONG", "1", 1);
    assert(bn_gpu_policy_cuda_q6k_2warp_long_enabled(2560, 8192));
    setenv("BN_CUDA_DISABLE_Q6K_2WARP_LONG", "1", 1);
    assert(!bn_gpu_policy_cuda_q6k_2warp_long_enabled(2560, 8192));
    assert(bn_gpu_policy_cuda_q6k_matvec4_shape_disabled(1024, 2560));
    assert(bn_gpu_policy_cuda_q6k_matvec4_shape_disabled(512, 2048));
    assert(!bn_gpu_policy_cuda_q6k_matvec4_shape_disabled(768, 2048));
    ...
    unsetenv("BN_CUDA_ENABLE_Q6K_MOE_DOWN_F32_CACHE");
    unsetenv("BN_CUDA_DISABLE_Q6K_MOE_DOWN_F32_CACHE");
    assert(bn_gpu_policy_cuda_q6k_moe_quant_down_preferred(
    ...
    assert(bn_gpu_policy_cuda_q6k_moe_float_down_enabled());
    setenv("BN_CUDA_DISABLE_Q6K_FLOAT_MOE_DOWN", "1", 1);
    assert(!bn_gpu_policy_cuda_q6k_moe_float_down_enabled());
    unsetenv("BN_CUDA_DISABLE_Q6K_FLOAT_MOE_DOWN");
    assert(bn_gpu_policy_cuda_q6k_moe_pair_down_enabled(0, 0, 0));
    assert(!bn_gpu_policy_cuda_q6k_moe_pair_down_enabled(1, 0, 0));
    assert(!bn_gpu_policy_cuda_q6k_moe_pair_down_enabled(0, 1, 0));
    assert(!bn_gpu_policy_cuda_q6k_moe_pair_down_enabled(0, 0, 1));
    setenv("BN_CUDA_DISABLE_MOE_Q6K_PAIR_DOWN", "1", 1);
    assert(!bn_gpu_policy_cuda_q6k_moe_pair_down_enabled(0, 0, 0));
    unsetenv("BN_CUDA_DISABLE_MOE_Q6K_PAIR_DOWN");
    assert(bn_gpu_policy_cuda_q6k_moe_prefer_f32_down(1, 4096, 0, 0));
    assert(bn_gpu_policy_cuda_q6k_moe_prefer_f32_down(1, 4096, 1, 1));
    assert(!bn_gpu_policy_cuda_q6k_moe_prefer_f32_down(0, 4096, 0, 0));
    assert(!bn_gpu_policy_cuda_q6k_moe_prefer_f32_down(1, 2048, 0, 0));
    assert(!bn_gpu_policy_cuda_q6k_moe_prefer_f32_down(1, 4096, 1, 0));
    setenv("BN_CUDA_DISABLE_Q6K_MOE_DOWN_F32_CACHE", "1", 1);
    assert(!bn_gpu_policy_cuda_q6k_moe_prefer_f32_down(1, 4096, 0, 0));
    assert(!bn_gpu_policy_cuda_q6k_moe_down_f32_cache_enabled(1, 0));
    unsetenv("BN_CUDA_DISABLE_Q6K_MOE_DOWN_F32_CACHE");
    assert(bn_gpu_policy_cuda_q6k_moe_down_f32_pair2_enabled(2, 2));
    assert(!bn_gpu_policy_cuda_q6k_moe_down_f32_pair2_enabled(4, 2));
    setenv("BN_CUDA_DISABLE_Q6K_MOE_DOWN_F32_PAIR2", "1", 1);
    assert(!bn_gpu_policy_cuda_q6k_moe_down_f32_pair2_enabled(2, 2));
    unsetenv("BN_CUDA_DISABLE_Q6K_MOE_DOWN_F32_PAIR2");
    assert(bn_gpu_policy_cuda_q6k_moe_down_f32_pair2_4row_enabled());
    setenv("BN_CUDA_DISABLE_Q6K_MOE_DOWN_F32_4ROW", "1", 1);
    assert(!bn_gpu_policy_cuda_q6k_moe_down_f32_pair2_4row_enabled());
    unsetenv("BN_CUDA_DISABLE_Q6K_MOE_DOWN_F32_4ROW");
    assert(!bn_gpu_policy_cuda_q6k_moe_down_q8k_all2_accum_enabled(1));
    setenv("BN_CUDA_ENABLE_MOE_Q6K_ALL2_ACCUM", "1", 1);
    assert(bn_gpu_policy_cuda_q6k_moe_down_q8k_all2_accum_enabled(1));
    assert(!bn_gpu_policy_cuda_q6k_moe_down_q8k_all2_accum_enabled(0));
    setenv("BN_CUDA_DISABLE_MOE_Q6K_ALL2_ACCUM", "1", 1);
    assert(!bn_gpu_policy_cuda_q6k_moe_down_q8k_all2_accum_enabled(1));
    unsetenv("BN_CUDA_ENABLE_MOE_Q6K_ALL2_ACCUM");
    unsetenv("BN_CUDA_DISABLE_MOE_Q6K_ALL2_ACCUM");
    assert(bn_gpu_policy_cuda_q6k_moe_down_q8k_pair4_sum_enabled(1));
    assert(!bn_gpu_policy_cuda_q6k_moe_down_q8k_pair4_sum_enabled(0));
    setenv("BN_CUDA_DISABLE_MOE_Q6K_PAIR4_SUM", "1", 1);
    assert(!bn_gpu_policy_cuda_q6k_moe_down_q8k_pair4_sum_enabled(1));
    unsetenv("BN_CUDA_DISABLE_MOE_Q6K_PAIR4_SUM");
    assert(bn_gpu_policy_cuda_q6k_moe_down_q8k_k8_4row_sum_enabled(
        0, 8, 1024));
    assert(!bn_gpu_policy_cuda_q6k_moe_down_q8k_k8_4row_sum_enabled(
        1, 8, 1024));
    assert(!bn_gpu_policy_cuda_q6k_moe_down_q8k_k8_4row_sum_enabled(
    ...
    assert(!bn_gpu_policy_cuda_q6k_moe_down_q8k_k8_4row_sum_enabled(
        0, 8, 1024));
    unsetenv("BN_CUDA_DISABLE_MOE_Q6K_K8_4ROW_SUM");
    assert(!bn_gpu_policy_cuda_q6k_moe_down_q8k_k8_8row_sum_enabled(
        1, 1024));
    ...
    assert(!bn_gpu_policy_cuda_q6k_moe_down_q8k_k8_8row_sum_enabled(
        0, 1024));
    unsetenv("BN_CUDA_ENABLE_MOE_Q6K_K8_8ROW_SUM");
    assert(bn_gpu_policy_cuda_q6k_moe_down_q8k_all2_fixed_enabled(1));
    setenv("BN_CUDA_DISABLE_MOE_Q6K_ALL2_FIXED", "1", 1);
    assert(!bn_gpu_policy_cuda_q6k_moe_down_q8k_all2_fixed_enabled(1));
    unsetenv("BN_CUDA_DISABLE_MOE_Q6K_ALL2_FIXED");
    assert(bn_gpu_policy_cuda_q6k_moe_down_resid_rmsnorm_fuse_enabled());
    setenv("BN_CUDA_DISABLE_MOE_DOWN_RESID_RMSNORM_FUSE", "1", 1);
    assert(!bn_gpu_policy_cuda_q6k_moe_down_resid_rmsnorm_fuse_enabled());
    unsetenv("BN_CUDA_DISABLE_MOE_DOWN_RESID_RMSNORM_FUSE");
    assert(bn_gpu_policy_cuda_q6k_moe_down_q8k_k8_exact_2048_768_enabled(
        2048, 768, 8));
    assert(!bn_gpu_policy_cuda_q6k_moe_down_q8k_k8_exact_2048_768_enabled(
        2048, 1024, 8));
    ...
    assert(!bn_gpu_policy_cuda_q6k_moe_down_q8k_k8_exact_2048_768_enabled(
        2048, 768, 8));
    unsetenv("BN_CUDA_DISABLE_MOE_Q6K_K8_EXACT_2048_768");
    assert(!bn_gpu_policy_cuda_q6k_moe_down_q8k_all2_accum_4row_enabled());
    setenv("BN_CUDA_ENABLE_MOE_Q6K_ALL2_ACCUM_4ROW", "1", 1);
    assert(bn_gpu_policy_cuda_q6k_moe_down_q8k_all2_accum_4row_enabled());
    unsetenv("BN_CUDA_ENABLE_MOE_Q6K_ALL2_ACCUM_4ROW");
    assert(bn_gpu_policy_cuda_q6k_moe_down_q8k_pair_4row_enabled());
    setenv("BN_CUDA_DISABLE_MOE_Q6K_PAIR_DOWN_4ROW", "1", 1);
    assert(!bn_gpu_policy_cuda_q6k_moe_down_q8k_pair_4row_enabled());
    unsetenv("BN_CUDA_DISABLE_MOE_Q6K_PAIR_DOWN_4ROW");
    assert(bn_gpu_policy_cuda_q6k_moe_down_f32_cache_enabled(1, 0));
    assert(!bn_gpu_policy_cuda_q6k_moe_down_f32_cache_enabled(0, 0));
    assert(!bn_gpu_policy_cuda_q6k_moe_down_f32_cache_enabled(1, 1));
    assert(!bn_gpu_policy_cuda_q6k_moe_down_f16_cache_enabled(1));
    setenv("BN_CUDA_ENABLE_Q6K_MOE_DOWN_F16_CACHE", "1", 1);
    assert(bn_gpu_policy_cuda_q6k_moe_down_f16_cache_enabled(1));
    setenv("BN_CUDA_DISABLE_Q6K_MOE_DOWN_F16_CACHE", "1", 1);
    assert(!bn_gpu_policy_cuda_q6k_moe_down_f16_cache_enabled(1));
    assert(bn_gpu_policy_cuda_q4k_moe_down_f32_cache_enabled(1));
    assert(!bn_gpu_policy_cuda_q4k_moe_down_f32_cache_enabled(0));
    setenv("BN_CUDA_DISABLE_Q4K_MOE_DOWN_F32_CACHE", "1", 1);
    assert(!bn_gpu_policy_cuda_q4k_moe_down_f32_cache_enabled(1));
    unsetenv("BN_CUDA_DISABLE_Q4K_MOE_DOWN_F32_CACHE");
    assert(!bn_gpu_policy_cuda_q4k_moe_pair_down_enabled(2, 2, 4096));
    setenv("BN_CUDA_ENABLE_MOE_Q4K_PAIR_DOWN", "1", 1);
    assert(bn_gpu_policy_cuda_q4k_moe_pair_down_enabled(2, 2, 4096));
    assert(!bn_gpu_policy_cuda_q4k_moe_pair_down_enabled(4, 2, 4096));
    assert(!bn_gpu_policy_cuda_q4k_moe_pair_down_enabled(2, 2, 2048));
    setenv("BN_CUDA_DISABLE_MOE_Q4K_PAIR_DOWN", "1", 1);
    assert(!bn_gpu_policy_cuda_q4k_moe_pair_down_enabled(2, 2, 4096));
    unsetenv("BN_CUDA_ENABLE_MOE_Q4K_PAIR_DOWN");
    unsetenv("BN_CUDA_DISABLE_MOE_Q4K_PAIR_DOWN");
    assert(!bn_gpu_policy_cuda_q4k_moe_down_8row_enabled(1024));
    setenv("BN_CUDA_ENABLE_MOE_Q4K_DOWN_8ROW", "1", 1);
    assert(bn_gpu_policy_cuda_q4k_moe_down_8row_enabled(1024));
    assert(!bn_gpu_policy_cuda_q4k_moe_down_8row_enabled(1025));
    ...
    assert(bn_gpu_policy_cuda_q4k_q8k_moe_gateup_enabled(1, 4096, 0));
    assert(bn_gpu_policy_cuda_q4k_q8k_moe_gateup_enabled(2, 2048, 1));
    assert(!bn_gpu_policy_cuda_q4k_q8k_moe_gateup_enabled(2, 2048, 0));
    assert(!bn_gpu_policy_cuda_q4k_q8k_moe_gateup_enabled(2, 4096, 1));
    setenv("BN_CUDA_ENABLE_Q4K_Q8K_MOE_GATEUP", "1", 1);
    assert(bn_gpu_policy_cuda_q4k_q8k_moe_gateup_enabled(2, 4096, 0));
    setenv("BN_CUDA_DISABLE_Q4K_Q8K_DOT", "1", 1);
    assert(!bn_gpu_policy_cuda_q4k_q8k_moe_gateup_enabled(1, 2048, 1));
    unsetenv("BN_CUDA_DISABLE_Q4K_Q8K_DOT");
    unsetenv("BN_CUDA_ENABLE_Q4K_Q8K_MOE_GATEUP");
    assert(bn_gpu_policy_cuda_q4k_moe_gateup_8row_enabled(2048));
    assert(!bn_gpu_policy_cuda_q4k_moe_gateup_8row_enabled(2049));
    setenv("BN_CUDA_DISABLE_MOE_GATEUP_8ROW", "1", 1);
    assert(!bn_gpu_policy_cuda_q4k_moe_gateup_8row_enabled(2048));
    unsetenv("BN_CUDA_DISABLE_MOE_GATEUP_8ROW");
    assert(!bn_gpu_policy_cuda_q4k_moe_gateup_split_enabled(2048, 2));
    assert(!bn_gpu_policy_cuda_q4k_moe_gateup_split_enabled(2049, 4));
    setenv("BN_CUDA_ENABLE_MOE_GATEUP_SPLIT", "1", 1);
    assert(bn_gpu_policy_cuda_q4k_moe_gateup_split_enabled(2048, 4));
    ...
    assert(bn_gpu_policy_cuda_q8_moe_q8_1_batch_enabled(1));
    assert(!bn_gpu_policy_cuda_q8_moe_q8_1_batch_enabled(0));
    assert(bn_gpu_policy_cuda_q8_moe_gateup_2row_enabled(1024));
    assert(!bn_gpu_policy_cuda_q8_moe_gateup_2row_enabled(1025));
    assert(!bn_gpu_policy_cuda_q8_moe_down_4row_enabled(1024));
    assert(bn_gpu_policy_cuda_q8_moe_down_2row_enabled(1024));
    ...
    assert(!bn_gpu_policy_cuda_q5k_deint_pair_matvec_enabled());
    assert(bn_gpu_policy_cuda_q5k_4warp_enabled(8192));
    assert(!bn_gpu_policy_cuda_q5k_4warp_enabled(8193));
    assert(!bn_gpu_policy_cuda_q5k_split_4warp_enabled(8192));
    assert(bn_gpu_policy_cuda_q5k_gateup_2warp_enabled());
    ...
    assert(bn_gpu_policy_cuda_q4k_dot_enabled());
    assert(bn_gpu_policy_cuda_q5k_dot_enabled());
    assert(bn_gpu_policy_cuda_q4k_4warp_enabled());
    assert(bn_gpu_policy_cuda_q4k_4warp_shape_enabled(1536, 8960));
    assert(bn_gpu_policy_cuda_q4k_4warp_shape_enabled(2560, 9728));
    assert(!bn_gpu_policy_cuda_q4k_4warp_shape_enabled(3072, 9728));
    assert(!bn_gpu_policy_cuda_q4k_out_residual_rmsnorm_fuse_enabled());
    assert(!bn_gpu_policy_cuda_q4k_qkv_mixed_fuse_enabled(
        BN_GGUF_TENSOR_Q4_K));
    assert(bn_gpu_policy_cuda_q4k_qkv_mixed_fuse_enabled(
        BN_GGUF_TENSOR_Q5_K));
    assert(!bn_gpu_policy_cuda_q4k_split_k_rope_cache_fuse_enabled());
    assert(bn_gpu_policy_cuda_q4k_split_qk_rope_cache_fuse_enabled());
    assert(bn_gpu_policy_cuda_q4k_split_4warp_enabled(2048));
    assert(!bn_gpu_policy_cuda_q4k_split_4warp_enabled(2560));
    assert(bn_gpu_policy_cuda_q4k_split_5warp_enabled(2560));
    assert(!bn_gpu_policy_cuda_q4k_split_5warp_enabled(2048));
    assert(bn_gpu_policy_cuda_q4k_split_value_rows(4608, 2048) == 512);
    assert(bn_gpu_policy_cuda_q4k_split_value_rows(2304, 2048) == 256);
    assert(bn_gpu_policy_cuda_q4k_split_value_rows(1792, 1536) == 0);
    assert(bn_gpu_policy_cuda_q4k_split_value_fuse_enabled(256));
    assert(!bn_gpu_policy_cuda_q4k_split_value_fuse_enabled(0));
    assert(!bn_gpu_policy_cuda_q4k_gateup_q8k_path_enabled(0));
    assert(bn_gpu_policy_cuda_q4k_gateup_q8k_path_enabled(1));
    assert(bn_gpu_policy_cuda_q4k_gateup_qwarp4_enabled(4096));
    assert(!bn_gpu_policy_cuda_q4k_gateup_qwarp4_enabled(4097));
    assert(bn_gpu_policy_cuda_q4k_gateup_5warp_enabled(1, 2560));
    assert(!bn_gpu_policy_cuda_q4k_gateup_5warp_enabled(0, 2560));
    ...
    assert(bn_gpu_policy_cuda_q8_0_ssm_preq_enabled());
    assert(!bn_gpu_policy_cuda_q8_mixed_preq_enabled(
        BN_GGUF_TENSOR_Q8_0, BN_GGUF_TENSOR_Q4_K, 2048));
    assert(bn_gpu_policy_cuda_moe_route_q8k_prequant_enabled(2048, 1));
    assert(!bn_gpu_policy_cuda_moe_route_q8k_prequant_enabled(2049, 1));
    assert(!bn_gpu_policy_cuda_moe_route_q8k_prequant_enabled(2048, 0));
    assert(!bn_gpu_policy_cuda_moe_route_q8_1_prequant_enabled(2048, 1, 0));
    assert(!bn_gpu_policy_cuda_moe_route_q8_1_prequant_enabled(2048, 1, 1));
    ...
    assert(bn_gpu_policy_cuda_moe_q4k_all2_fixed_4row_enabled(1, 1));
    assert(!bn_gpu_policy_cuda_moe_q4k_all2_fixed_4row_enabled(0, 1));
    assert(!bn_gpu_policy_cuda_moe_q4k_gateup_4row_disabled());
    ...
    setenv("BN_CUDA_DISABLE_Q4K_4WARP_1536_8960", "1", 1);
    setenv("BN_CUDA_DISABLE_Q4K_4WARP_2560_9728", "1", 1);
    setenv("BN_CUDA_ENABLE_Q4K_OUT_RESID_RMSNORM_FUSE", "1", 1);
    setenv("BN_CUDA_ENABLE_Q4K_QKV_MIXED_FUSE", "1", 1);
    setenv("BN_CUDA_ENABLE_Q4K_SPLIT_K_ROPE_CACHE_FUSE", "1", 1);
    setenv("BN_CUDA_DISABLE_Q4K_SPLIT_QK_ROPE_CACHE_FUSE", "1", 1);
    setenv("BN_CUDA_DISABLE_Q4K_SPLIT_4WARP_2048", "1", 1);
    setenv("BN_CUDA_DISABLE_Q4K_SPLIT_5WARP_2560", "1", 1);
    setenv("BN_CUDA_ENABLE_Q4K_SPLIT_VALUE_FUSE_1792", "1", 1);
    setenv("BN_CUDA_DISABLE_Q4K_SPLIT_VALUE_FUSE", "1", 1);
    setenv("BN_CUDA_DISABLE_Q4K_GATEUP_Q8_1_FAST", "1", 1);
    setenv("BN_CUDA_DISABLE_Q4K_GATEUP_QWARP4", "1", 1);
    setenv("BN_CUDA_DISABLE_Q4K_GATEUP_5WARP_2560", "1", 1);
    setenv("BN_CUDA_DISABLE_Q4K_GATEUP_2WARP", "1", 1);
    ...
    assert(bn_gpu_policy_cuda_q4k_qkv_mixed_fuse_enabled(
        BN_GGUF_TENSOR_Q4_K));
    assert(bn_gpu_policy_cuda_q4k_split_k_rope_cache_fuse_enabled());
    setenv("BN_CUDA_DISABLE_Q4K_SPLIT_K_ROPE_CACHE_FUSE", "1", 1);
    assert(!bn_gpu_policy_cuda_q4k_split_k_rope_cache_fuse_enabled());
    assert(!bn_gpu_policy_cuda_q4k_split_qk_rope_cache_fuse_enabled());
    assert(!bn_gpu_policy_cuda_q4k_split_4warp_enabled(2048));
    assert(!bn_gpu_policy_cuda_q4k_split_5warp_enabled(2560));
    assert(bn_gpu_policy_cuda_q4k_split_value_rows(1792, 1536) == 256);
    assert(!bn_gpu_policy_cuda_q4k_split_value_fuse_enabled(256));
    assert(bn_gpu_policy_cuda_q4k_gateup_q8k_path_enabled(0));
    assert(!bn_gpu_policy_cuda_q4k_gateup_qwarp4_enabled(4096));
    assert(!bn_gpu_policy_cuda_q4k_gateup_5warp_enabled(1, 2560));
    ...
    unsetenv("BN_CUDA_DISABLE_MOE_Q4K_Q8K_DOT");
    setenv("BN_CUDA_ENABLE_MOE_Q4K_Q8K_DOT_ALL2", "1", 1);
    assert(bn_gpu_policy_cuda_moe_q4k_q8k_dot_enabled(0, 0, 1, 2048,
                                                      2048));
    assert(bn_gpu_policy_cuda_moe_internal_profile_enabled(1));
    ...
    assert(bn_gpu_policy_cuda_q4k_q8k_dot_enabled());
    assert(!bn_gpu_policy_cuda_q4k_q8k_dot_forced());
    assert(bn_gpu_policy_cuda_q4k_pair_matvec_enabled());
    assert(!bn_gpu_policy_cuda_q4k_q8k_matvec4_enabled(8192));
    assert(bn_gpu_policy_cuda_q4k_q8k_matvec4_enabled(16384));
    assert(!bn_gpu_policy_cuda_q4k_matmul8_enabled());
    assert(bn_gpu_policy_cuda_q4k_sharedx_enabled());
    assert(!bn_gpu_policy_cuda_q4k_batch_sharedx_enabled());
    setenv("BN_CUDA_DISABLE_Q4K_Q8K_DOT", "1", 1);
    setenv("BN_CUDA_ENABLE_Q4K_Q8K_DOT", "1", 1);
    setenv("BN_CUDA_DISABLE_Q4K_PAIR_MATVEC", "1", 1);
    setenv("BN_CUDA_DISABLE_Q4K_Q8K_MATVEC4", "1", 1);
    setenv("BN_CUDA_ENABLE_Q4K_MATMUL8", "1", 1);
    setenv("BN_CUDA_DISABLE_Q4K_SHAREDX_BATCH", "1", 1);
    setenv("BN_CUDA_ENABLE_Q4K_SHAREDX_BATCH", "1", 1);
    assert(!bn_gpu_policy_cuda_q4k_q8k_dot_enabled());
    assert(bn_gpu_policy_cuda_q4k_q8k_dot_forced());
    assert(!bn_gpu_policy_cuda_q4k_pair_matvec_enabled());
    assert(!bn_gpu_policy_cuda_q4k_q8k_matvec4_enabled(16384));
    ...
    assert(bn_gpu_policy_cuda_q6k_dot_enabled());
    assert(!bn_gpu_policy_cuda_q6k_dot_forced());
    assert(!bn_gpu_policy_cuda_q6k_warp_enabled());
    assert(bn_gpu_policy_cuda_q6k_q4k_pair_matvec_enabled(4096));
    assert(!bn_gpu_policy_cuda_q6k_q4k_pair_matvec_enabled(5120));
    assert(!bn_gpu_policy_cuda_q6k_q8_1_dot_enabled(1));
    assert(bn_gpu_policy_cuda_q6k_mmvq_enabled(5120, 4096, 0, 0));
    assert(bn_gpu_policy_cuda_q6k_mmvq_enabled(512, 2048, 0, 0));
    assert(bn_gpu_policy_cuda_q6k_mmvq_enabled(1536, 8960, 0, 0));
    assert(bn_gpu_policy_cuda_q6k_mmvq_enabled(2560, 9728, 0, 0));
    assert(bn_gpu_policy_cuda_q6k_mmvq_enabled(50000, 1536, 1, 0));
    assert(!bn_gpu_policy_cuda_q6k_mmvq_enabled(5120, 4096, 0, 1));
    assert(bn_gpu_policy_cuda_q6k_mmvq_2warp_logits_enabled(50000, 1536, 1));
    assert(bn_gpu_policy_cuda_q6k_mmvq_2warp_logits_enabled(50000, 2048, 1));
    assert(!bn_gpu_policy_cuda_q6k_mmvq_2warp_logits_enabled(50000, 1536, 0));
    assert(!bn_gpu_policy_cuda_q6k_down_residual_rmsnorm_fuse_enabled());
    assert(bn_gpu_policy_cuda_f16_q6k_matvec_enabled(2048, 8192, 0));
    assert(!bn_gpu_policy_cuda_f16_q6k_matvec_enabled(2048, 8192, 1));
    assert(!bn_gpu_policy_cuda_f16_q6k_matvec_enabled(2048, 4096, 0));
    assert(!bn_gpu_policy_cuda_q6k_matmul8_enabled());
    assert(bn_gpu_policy_cuda_q6k_matmul4_enabled());
    assert(bn_gpu_policy_cuda_q6k_matvec4_enabled());
    assert(!bn_gpu_policy_cuda_q6k_batch_warp_enabled());
    setenv("BN_CUDA_DISABLE_Q6K_DOT", "1", 1);
    setenv("BN_CUDA_ENABLE_Q6K_DOT", "1", 1);
    setenv("BN_CUDA_ENABLE_Q6K_WARP", "1", 1);
    setenv("BN_CUDA_ENABLE_Q6K_Q4K_PAIR_MATVEC", "1", 1);
    setenv("BN_CUDA_ENABLE_Q6K_Q8_1_DOT", "1", 1);
    setenv("BN_CUDA_DISABLE_Q6K_MMVQ_512_2048", "1", 1);
    setenv("BN_CUDA_DISABLE_Q6K_MMVQ_1536_8960", "1", 1);
    setenv("BN_CUDA_DISABLE_Q6K_MMVQ_2560_9728", "1", 1);
    setenv("BN_CUDA_DISABLE_Q6K_MMVQ_LOGITS_1536", "1", 1);
    setenv("BN_CUDA_DISABLE_Q6K_MMVQ_2WARP_LOGITS_SMALL", "1", 1);
    setenv("BN_CUDA_DISABLE_Q6K_MMVQ_2WARP_1536", "1", 1);
    setenv("BN_CUDA_ENABLE_Q6K_DOWN_RESID_RMSNORM_FUSE", "1", 1);
    setenv("BN_CUDA_ENABLE_F16_Q6K_MATVEC", "1", 1);
    setenv("BN_CUDA_ENABLE_Q6K_MATMUL8", "1", 1);
    setenv("BN_CUDA_DISABLE_Q6K_MATMUL4", "1", 1);
    setenv("BN_CUDA_DISABLE_Q6K_MATVEC4", "1", 1);
    setenv("BN_CUDA_ENABLE_Q6K_BATCH_WARP", "1", 1);
    assert(!bn_gpu_policy_cuda_q6k_dot_enabled());
    assert(bn_gpu_policy_cuda_q6k_dot_forced());
    assert(bn_gpu_policy_cuda_q6k_warp_enabled());
    assert(bn_gpu_policy_cuda_q6k_q4k_pair_matvec_enabled(5120));
    assert(bn_gpu_policy_cuda_q6k_q8_1_dot_enabled(1));
    assert(!bn_gpu_policy_cuda_q6k_q8_1_dot_enabled(0));
    setenv("BN_CUDA_ENABLE_Q6K_Q8_1_ALL", "1", 1);
    assert(bn_gpu_policy_cuda_q6k_q8_1_dot_enabled(0));
    setenv("BN_CUDA_DISABLE_Q6K_Q8_1_DOT", "1", 1);
    assert(!bn_gpu_policy_cuda_q6k_q8_1_dot_enabled(1));
    assert(!bn_gpu_policy_cuda_q6k_mmvq_enabled(512, 2048, 0, 0));
    assert(!bn_gpu_policy_cuda_q6k_mmvq_enabled(1536, 8960, 0, 0));
    assert(!bn_gpu_policy_cuda_q6k_mmvq_enabled(2560, 9728, 0, 0));
    ...
    assert(!bn_gpu_policy_cuda_q6k_matvec4_enabled());
    assert(bn_gpu_policy_cuda_q6k_batch_warp_enabled());
    setenv("BN_CUDA_DISABLE_Q6K_Q4K_PAIR_MATVEC", "1", 1);
    setenv("BN_CUDA_DISABLE_Q6K_MMVQ", "1", 1);
    setenv("BN_CUDA_DISABLE_F16_Q6K_MATVEC", "1", 1);
    assert(!bn_gpu_policy_cuda_q6k_q4k_pair_matvec_enabled(4096));
    assert(!bn_gpu_policy_cuda_q6k_mmvq_enabled(5120, 4096, 0, 0));
    assert(bn_gpu_policy_cuda_f16_q6k_matvec_enabled(2048, 4096, 0));
    unsetenv("BN_CUDA_ENABLE_F16_Q6K_MATVEC");
    ...
    assert(bn_gpu_policy_q8_moe_cpu_route_resident_enabled(1));
    assert(!bn_gpu_policy_q8_moe_cpu_route_resident_enabled(0));
    ...
    assert(!bn_gpu_policy_small_dense_q8_logits_refine_enabled());
    assert(!bn_gpu_policy_small_dense_q8_logits_refine_disabled());
    ...
    assert(!bn_gpu_policy_all2_q4q6_moe_q6_logits_refine_disabled());
...
static void test_quant_registry(void) {
    ...
    assert(!bn_backend_quant_moe_routed_q8(BN_GGUF_TENSOR_Q8_0,
                                           BN_GGUF_TENSOR_Q8_0,
                                           BN_GGUF_TENSOR_Q4_K));
    assert(bn_backend_quant_moe_routed_op_is_q8(BN_GGUF_TENSOR_Q8_0));
    ...
    assert(!bn_backend_quant_cuda_logits_q6_matvec_candidate(
        BN_GGUF_TENSOR_Q8_0));
    assert(bn_backend_quant_cuda_q5_0_matvec_candidate(
        BN_GGUF_TENSOR_Q5_0));
    assert(!bn_backend_quant_cuda_q5_0_matvec_candidate(
        BN_GGUF_TENSOR_Q5_K));
    assert(bn_backend_quant_cuda_q6k_q8k_matvec_candidate(
        BN_GGUF_TENSOR_Q6_K));
    assert(!bn_backend_quant_cuda_q6k_q8k_matvec_candidate(
        BN_GGUF_TENSOR_Q4_K));
    assert(bn_backend_quant_cuda_q6k_warp_matvec_candidate(
        BN_GGUF_TENSOR_Q6_K));
    assert(!bn_backend_quant_cuda_q6k_warp_matvec_candidate(
        BN_GGUF_TENSOR_Q4_K));
    assert(bn_backend_quant_cuda_q4k_q8k_matvec_candidate(
        BN_GGUF_TENSOR_Q4_K));
    assert(!bn_backend_quant_cuda_q4k_q8k_matvec_candidate(
        BN_GGUF_TENSOR_Q6_K));
    assert(bn_backend_quant_cuda_q4k_q8_1_matvec_candidate(
        BN_GGUF_TENSOR_Q4_K));
    assert(!bn_backend_quant_cuda_q4k_q8_1_matvec_candidate(
        BN_GGUF_TENSOR_Q6_K));
    assert(bn_backend_quant_cuda_q5k_q8_1_matvec_candidate(
        BN_GGUF_TENSOR_Q5_K));
    assert(!bn_backend_quant_cuda_q5k_q8_1_matvec_candidate(
        BN_GGUF_TENSOR_Q4_K));
    assert(bn_backend_quant_cuda_q8_0_preq_matvec_candidate(
        BN_GGUF_TENSOR_Q8_0));
    assert(!bn_backend_quant_cuda_q8_0_preq_matvec_candidate(
        BN_GGUF_TENSOR_Q4_K));
    assert(bn_backend_quant_cuda_q8_0_warp_matvec_candidate(
        BN_GGUF_TENSOR_Q8_0));
    assert(!bn_backend_quant_cuda_q8_0_warp_matvec_candidate(
        BN_GGUF_TENSOR_Q4_K));
    assert(bn_backend_quant_cuda_q4k_q8k_matmul_candidate(
        BN_GGUF_TENSOR_Q4_K));
    assert(!bn_backend_quant_cuda_q4k_q8k_matmul_candidate(
        BN_GGUF_TENSOR_Q6_K));
    assert(bn_backend_quant_cuda_q4k_q8_1_matmul_candidate(
        BN_GGUF_TENSOR_Q4_K));
    assert(!bn_backend_quant_cuda_q4k_q8_1_matmul_candidate(
        BN_GGUF_TENSOR_Q6_K));
    assert(bn_backend_quant_cuda_q5k_q8_1_matmul_candidate(
        BN_GGUF_TENSOR_Q5_K));
    assert(!bn_backend_quant_cuda_q5k_q8_1_matmul_candidate(
        BN_GGUF_TENSOR_Q4_K));
    assert(bn_backend_quant_cuda_q6k_q8k_matmul_candidate(
        BN_GGUF_TENSOR_Q6_K));
    assert(!bn_backend_quant_cuda_q6k_q8k_matmul_candidate(
        BN_GGUF_TENSOR_Q4_K));
    assert(bn_backend_quant_cuda_q8_0_matmul_candidate(
        BN_GGUF_TENSOR_Q8_0));
    assert(!bn_backend_quant_cuda_q8_0_matmul_candidate(
        BN_GGUF_TENSOR_Q4_K));
    ...
    assert(!bn_backend_quant_cuda_split_allows_fused_bias(
        BN_GGUF_TENSOR_Q8_0));
    assert(bn_backend_quant_cuda_q4k_split_q8k_candidate(
        BN_GGUF_TENSOR_Q4_K));
    assert(!bn_backend_quant_cuda_q4k_split_q8k_candidate(
        BN_GGUF_TENSOR_Q6_K));
    assert(bn_backend_quant_cuda_q4k_split_q8_1_candidate(
        BN_GGUF_TENSOR_Q4_K));
    assert(!bn_backend_quant_cuda_q4k_split_q8_1_candidate(
        BN_GGUF_TENSOR_Q5_K));
    assert(bn_backend_quant_cuda_q5k_split_q8_1_candidate(
        BN_GGUF_TENSOR_Q5_K));
    assert(!bn_backend_quant_cuda_q5k_split_q8_1_candidate(
        BN_GGUF_TENSOR_Q4_K));
    assert(bn_backend_quant_cuda_q8_0_split_candidate(
        BN_GGUF_TENSOR_Q8_0));
    assert(!bn_backend_quant_cuda_q8_0_split_candidate(
        BN_GGUF_TENSOR_Q4_K));
    assert(bn_backend_quant_cuda_q4k_split_value_fuse_candidate(
        BN_GGUF_TENSOR_Q4_K));
    assert(!bn_backend_quant_cuda_q4k_split_value_fuse_candidate(
        BN_GGUF_TENSOR_Q6_K));
    assert(bn_backend_quant_cuda_q6k_split_value_fuse_candidate(
        BN_GGUF_TENSOR_Q6_K));
    assert(!bn_backend_quant_cuda_q6k_split_value_fuse_candidate(
        BN_GGUF_TENSOR_Q4_K));
    assert(bn_backend_quant_cuda_split_value_fuse_candidate(
        BN_GGUF_TENSOR_Q4_K));
    assert(bn_backend_quant_cuda_split_value_fuse_candidate(
        BN_GGUF_TENSOR_Q6_K));
    assert(!bn_backend_quant_cuda_split_value_fuse_candidate(
    ...
    assert(bn_quant_format_cuda_lazy_moe_aux_cache_candidate(BN_GGUF_TENSOR_Q5_K));
    ...
    assert(bn_quant_format_cuda_aux_cache_prefers_large_budget(
        BN_GGUF_TENSOR_Q4_K));
    assert(bn_backend_quant_cuda_aux_cache_force_q4_f32(
        BN_GGUF_TENSOR_Q4_K, 1));
    assert(!bn_backend_quant_cuda_aux_cache_force_q4_f32(
        BN_GGUF_TENSOR_Q6_K, 1));
    assert(!bn_backend_quant_cuda_aux_cache_force_q4_f32(
        BN_GGUF_TENSOR_Q4_K, 0));
    assert(bn_backend_quant_cuda_aux_cache_q6_can_use_f16(
    ...
    assert(bn_backend_quant_cuda_aux_cache_add_q6_f32(
        BN_GGUF_TENSOR_Q6_K, 1));
    assert(!bn_backend_quant_cuda_aux_cache_add_q6_f32(
        BN_GGUF_TENSOR_Q6_K, 0));
    assert(!bn_backend_quant_cuda_aux_cache_add_q6_f32(
