...
if grep -n 'bn_transformer_gpu_cuda_moe_\(prefill_enabled\|prefill_min_tokens\|cache_prefill_enabled\|prefill_shared_fuse_enabled\|route_batch_debug_enabled\|lazy_aux_cache_enabled\|routed_ffn_batch_allowed\|ffn_disabled\|cpu_actual_override_enabled\|shared_cpu_fallback_enabled\|gateup_split_enabled\|cpu_route_resident_ffn_enabled\)' src/transformer/gpu_policy.c src/transformer/gpu_internal.h test/test_transformer.c >/dev/null 2>&1; then
