...
if grep -n 'bn_transformer_gpu_all_active_two_kquant_moe_exact_gpu_route_enabled\|\bexact_gpu_route\b' src/transformer/gpu_policy.c src/transformer/gpu_internal.h src/gpu_policy.c src/gpu_cuda.cu include/gpu_policy.h test/test_transformer.c test/test_gpu_backend.c >/dev/null 2>&1; then
