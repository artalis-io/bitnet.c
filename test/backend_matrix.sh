...
if grep -n 'bn_quant_format_cuda_matvec_supported\|bn_quant_policy_cuda_matvec_type_disabled\|bn_quant_format_cuda_cublas_aux_cache_supported\|bn_quant_format_cuda_q8_quant_matmul_on_f16_disable\|bn_quant_format_cuda_force_q[46]k_quant_matmul_candidate' include/quant.h src/quant test/test_quant.c >/dev/null 2>&1; then
