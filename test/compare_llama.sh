...
while [[ $# -gt 0 ]]; do
    case "$1" in
        ...
        --metal-disable-small-dense-exact-native|--metal-disable-q4-q8) BITNET_ARGS+=(--metal-disable-small-dense-exact-native); shift ;;
        ...
        --small-dense-exact-native-to-layer|--q4-q8-to-layer) BITNET_ARGS+=(--small-dense-exact-native-to-layer "$2"); shift 2 ;;
        --small-dense-exact-native-tail|--q4-q8-tail-native) BITNET_ARGS+=(--small-dense-exact-native-tail "$2"); shift 2 ;;
        --small-dense-exact-native-attn-only|--q4-q8-attn-only) BITNET_ARGS+=(--small-dense-exact-native-attn-only); shift ;;
        --small-dense-exact-native-ffn-only|--q4-q8-ffn-only) BITNET_ARGS+=(--small-dense-exact-native-ffn-only); shift ;;
