...
void bn_quant_q8_avx512_vnni_matmul_4row_range(void *ctx, int start, int end);
...
void bn_quant_q4k_avx512_x16_gemm_range(void *ctx, int start, int end);
...
void bn_quant_q6k_avx512_vnni_matmul_4row_range(void *ctx, int start, int end);
