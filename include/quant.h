...
typedef enum {
    ...
    BN_QUANT_CAP_MOE_ROUTED_KQUANT_GATEUP = 1u << 2,
    BN_QUANT_CAP_MOE_NATIVE_QUANT_ROUTE   = 1u << 3,
    ...
    BN_QUANT_CAP_LOGITS_KQUANT_F32_CACHE = 1u << 19,
    BN_QUANT_CAP_MOE_ALL_F16_CACHE = 1u << 20,
    BN_QUANT_CAP_MOE_DOWN_KQUANT_F32_CACHE = 1u << 21,
    BN_QUANT_CAP_MOE_DOWN_CUBLAS_CACHE = 1u << 22,
    BN_QUANT_CAP_MOE_DOWN_SMALL_KQUANT_F32_CACHE = 1u << 23,
    BN_QUANT_CAP_LAZY_MOE_AUX_CACHE_CANDIDATE = 1u << 24,
    BN_QUANT_CAP_MOE_PREFERS_QUANT_ONLY = 1u << 25,
...
int      bn_quant_q8_logits_refine_row(const BnQWeight *W,
                                        ...
                                        int row,
                                        float *out);
int      bn_quant_q6_logits_refine_row(const BnQWeight *W,
                                        const float *x,
                                        int row,
                                        float *out);
...
int      bn_quant_format_aux_cache_uses_f32(int type,
                                            int down_kquant_f16_cache);
