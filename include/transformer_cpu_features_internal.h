...
#if BN_TRANSFORMER_CPU_HAS_NEON_DOTPROD || BN_TRANSFORMER_CPU_HAS_AVX2 || \
    BN_TRANSFORMER_CPU_HAS_WASM_RELAXED_SIMD
#define BN_TRANSFORMER_CPU_HAS_NATIVE_QUANT_ACTIVATION 1
#else
#define BN_TRANSFORMER_CPU_HAS_NATIVE_QUANT_ACTIVATION 0
#endif
